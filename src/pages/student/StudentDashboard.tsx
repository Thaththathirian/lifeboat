...
export default function StudentHome() {
  ...
  const getStatusCard = () => {
    ...
    // Handle status 0 (NEW_USER) and status 1 (PERSONAL_DETAILS_PENDING) - Show form application
    if (currentApiStatus === StudentStatus.NEW_USER || currentApiStatus === StudentStatus.PERSONAL_DETAILS_PENDING) {
      console.log('Status is NEW_USER (0) or PERSONAL_DETAILS_PENDING (1), showing form application...');
      return (
