...
export const useStudentStatusSync = (options: UseStudentStatusSyncOptions = {}) => {
  ...
  return {
    ...
    isMobileVerified: currentStatus === StudentStatus.MOBILE_VERIFIED,
    isProfileUpdated: currentStatus === StudentStatus.PROFILE_UPDATED,
    isInterviewScheduled: currentStatus === StudentStatus.INTERVIEW_SCHEDULED,
    isDocumentUploaded: currentStatus === StudentStatus.DOCUMENT_UPLOADED,
    isWaitingForPayment: currentStatus === StudentStatus.WAITING_FOR_PAYMENT,
    isPaymentCompleted: currentStatus === StudentStatus.PAYMENT_COMPLETED,
    isPaymentVerified: currentStatus === StudentStatus.PAYMENT_VERIFIED,
    isReceiptVerified: currentStatus === StudentStatus.RECEIPT_VERIFIED,
    isCertificateUploaded: currentStatus === StudentStatus.CERTIFICATE_UPLOADED,
    isNextSemester: currentStatus === StudentStatus.NEXT_SEMESTER,
